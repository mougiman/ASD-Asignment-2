 ...
 <head>
    ...
    <body >
        ...
        <form action="editUser.jsp" method="POST">
            <table>
                     <tr><td>Full name</td><td><input type="text" name="name" size="25" value=" Calvin Thai<% //=user.getName()%>"></td></tr>
                ...
                <tr><td>Phone</td><td><input type="text" name="phone" size="25" value=" 04221191111<%//=user.getPhone()%>"></td></tr>
                        ...
                        <button class="button" type="button" onclick="location.href = 'index.jsp'" >Back</button>
